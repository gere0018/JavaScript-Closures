...
/*PART A
Build 6 paragraphs with filler text inside #main. When you click on the paragraph the index number of the paragraph becomes the innerHTML. Eg:  1, 2, 3, 4, 5, 6*/
  function clickPara ( ){
  for(var p=1; p <= 6; p++){
 ...
 clickPara();
  ...
  /*PART B
  //after the user clicks on the heading inside #second, start adding list items to the unordered list #theList. Use a for loop and a setTimeout. The delay for the first list item to appear is one second, two second delay for the second one, three second delay for the third and so on. Add a total of five list items to the ul.*/
